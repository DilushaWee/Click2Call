...
/**
 * CompanyUsageDAOImpl.java (UTF-8)
 * Apr 29, 2013, 4:10:24 PM
 *
 * @author Dewmini
 */
@Component
public class CompanyUsageDAOImpl extends GenericDAOImpl<CompanyUsage, Integer> implements CompanyUsageDAO{
