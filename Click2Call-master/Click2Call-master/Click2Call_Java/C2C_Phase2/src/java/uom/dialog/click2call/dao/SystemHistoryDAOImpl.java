...
/**
 * SystemHistoryDAOImpl.java (UTF-8)
 * Jun 18, 2013, 2:50:41 PM
 *
 * @author Dewmini
 */
@Component
public class SystemHistoryDAOImpl  extends GenericDAOImpl<SystemHistory, Integer> implements SystemHistoryDAO {
